...
def login():
    ...
    try:
        ...
        id = raw_input('\x1b[1;91m[+] \x1b[1;36mUsername SoHagLoveHacker ')
        pwd = getpass.getpass('\x1b[1;91m[+] \x1b[1;36mPassword SoHag  ')
        tik()
        try:
